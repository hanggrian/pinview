...
open class PinDialog @JvmOverloads constructor(
    ...
    init {
        ...
        view.setOnStateChangedListener { _, isComplete -> positiveButton.isEnabled = isComplete }
        negativeButton.setOnClickListener {
            mNegativeOnClick?.invoke(this, DialogInterface.BUTTON_NEGATIVE, view.text)
            hide()
        }
        positiveButton.setOnClickListener {
            mPositiveOnClick?.invoke(this, DialogInterface.BUTTON_POSITIVE, view.text)
            hide()
        }
    }
